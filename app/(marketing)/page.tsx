...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen " style={{ background: '#020108' }}>
      ...
      <div style={{ background: "#020108", position: "relative", zIndex: 2 }}>
