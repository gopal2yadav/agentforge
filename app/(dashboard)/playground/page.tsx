...
export default function PlaygroundPage() {
  ...
  useEffect(() => { fetch('/api/agents').then(r => r.json()).then((list) => { setAgents(list); try { const q = new URLSearchParams(window.location.search).get('agent'); if (q && Array.isArray(list) && list.some((a: any) => a.name === q)) setSelectedAgent(q); } catch {} }).catch(() => {}); }, []);
