    ...
    <div className="max-w-[1100px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">{agents.length} agents in your database</p>
        </div>
        <div className="flex gap-2">
          ...
          <Link href="/builder" className="px-4 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-600 hover:border-indigo-200">Deploy Swarm</Link>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white border border-gray-200 rounded-xl">
          <div className="w-12 h-12 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 text-xl font-bold mx-auto mb-3">A</div>
          <h3 className="text-lg font-semibold text-gray-900 mb-1">No agents yet</h3>
          <p className="text-sm text-gray-500 mb-4">Create your first AI agent or deploy a swarm</p>
          <div className="flex gap-3 justify-center">
            ...
            <Link href="/builder" className="px-4 py-2 rounded-lg border border-indigo-200 text-indigo-600 text-sm font-semibold hover:bg-indigo-50">Deploy Swarm</Link>
          </div>
        </div>
      ) : (
            ...
            <div key={a.id} className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:border-indigo-200 hover:shadow-md transition-all">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link href={'/playground?agent=' + encodeURIComponent(a.name)} className="text-xs text-indigo-600 hover:underline">Run</Link>
              ...
              <div className="flex items-center gap-4 text-xs text-gray-400">
                ...
                {a.goal && <span className="text-gray-500 truncate max-w-xs">{a.goal}</span>}
              </div>
            </div>
          ))}
        </div>
