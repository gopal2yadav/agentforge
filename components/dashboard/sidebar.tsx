        ...
        {nav.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href}
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${active ? 'bg-[#6366f1]/10 text-[#818cf8] font-semibold' : 'text-[#6b6b8a] hover:text-white hover:bg-[#14141f]'}`}>
